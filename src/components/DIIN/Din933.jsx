    ...
    <div>
      ...
      <div className="bg-gradient-to-r from-violet-600 to-violet-700 text-white p-6 sm:p-8">
        ...
        <p className="text-violet-100 text-lg">
          DIN 933 ISO 4017 HEXAGON HEAD BOLTS WITH FULL THREADS
        </p>
      </div>
      {/* Main Content */}
          ...
          <div className="space-y-6">
            <div>
              ...
              <p className="text-gray-700 leading-relaxed text-base sm:text-lg">
                DIN 933 ISO 4017 UNI 5739 hexagon head bolts with full threads
                is used in fastening components where full thread engagement is
                needed,sheet metal assemblies,light and medium-duty machinery
              </p>
            </div>
          </div>
          <div className="flex justify-center lg:justify-end">
            <div className="bg-gray-50 rounded-lg p-4 max-w-md">
              <img
                ...
                alt="DIN 933 ISO 4017 UNI 5739 Hexagon Head Bolt"
