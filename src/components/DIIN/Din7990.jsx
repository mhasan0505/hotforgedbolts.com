    ...
    <div>
      ...
      <div className="bg-gradient-to-r from-violet-600 to-violet-700 text-white p-6 sm:p-8">
        ...
        <p className="text-violet-100 text-lg">
          DIN 7990-ISO 4032- EN 14399-3 HEXAGON HEAD BOLT
        </p>
      </div>
      {/* Main Content */}
          ...
          <div className="space-y-6">
            <div>
              ...
              <p className="text-gray-700 leading-relaxed text-base sm:text-lg">
                DIN 7990 ISO 4032 EN 14399-3 UNI 5712 Hexagon Head Bolt is used
                in steel construction, particularly for non-preloaded structural
                bolted connections.
              </p>
            </div>
          </div>
          <div className="flex justify-center lg:justify-end">
            <div className="bg-gray-50 rounded-lg p-4 max-w-md">
              <img
                ...
                alt="DIN 7990 ISO 4032 EN 14399-3 Hexagon Head Bolt"
