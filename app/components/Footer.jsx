    ...
    <footer className="px-6 md:px-16 lg:px-24 xl:px-32 w-full">
      <div className="flex flex-col md:flex-row items-start justify-center gap-10 py-10 border-b border-gray-500/30">
        <div className="max-w-96">
          <h2 className="text-2xl font-bold text-gray-900">Hotforgedbolt</h2>
          <p className="mt-2 text-sm text-gray-500">
            Hotforgedbolt is a leading provider of high-quality forged bolts and
            nuts for industrial applications.
          </p>
      ...
      <p className="py-4 text-center text-xs md:text-sm text-gray-500">
        Copyright 2025 © <a href="https://prebuiltui.com">Hotforgedbolt</a>. All
        Right Reserved.
      </p>
    </footer>
  );
